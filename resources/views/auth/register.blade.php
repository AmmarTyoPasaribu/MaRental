  ...
  <div class="w-full max-w-md mx-auto px-4 animate-fade-in">
    ...
    <div class="glass-card rounded-2xl overflow-hidden">
      <div class="p-8 text-center border-b border-white/10">
        ...
        <p class="mt-2 text-white/40 text-sm">Buat akun baru</p>
      </div>
      ...
      <div class="p-8">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
          @csrf
          <div>
            <label class="block text-sm font-medium text-white/60 mb-2">Nama Lengkap</label>
            <div class="relative">
              <i class="bi bi-person absolute left-4 top-1/2 -translate-y-1/2 text-white/30"></i>
        ...
        <p class="mt-6 text-center text-sm text-white/40">
          Sudah punya akun?
          <a href="{{ route('login') }}" class="text-brand-400 hover:text-brand-300 font-medium transition-colors">Login</a>
        </p>
      </div>
    </div>
  </div>
